...
public class SemSearchTest extends TestCase {
    ...
    public void testMInitx()
    {
        ...
        args[0] = "128";
        args[1] = "solutionTestData/P2_testInput.txt";
        ...
        assertFuzzyEquals("Location Tree:\r\n"
            ...
            + "VT, computer, science\r\n"
            + "8 nodes visited in this search\r\n"
            + "Seminars with dates in range 0 to 05:\r\n"
        ...
        args[0] = "128";
        args[1] = "solutionTestData/fake.txt";
        systemOut().clearHistory();
        // Invoke main method of our Graph Project
        SemSearch.main(args);
        assertFuzzyEquals("", systemOut().getHistory());
        
        String[] argsInvld = {"128"};
        
        // Invoke main method of our Graph Project
        try
        {
            SemSearch.main(argsInvld);
        }
